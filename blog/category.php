...
if(isset($_REQUEST['cat'])){
    $category = Format::Stext($_REQUEST['cat']);
...
<html lang="en">
  <head>
    <title><?php echo $category; ?> Category | <?php echo web('web_title'); ?></title>

    <link rel="icon" href="../assets/images/logo/icon.png" type="image/png" sizes="16x16">

    <meta name="description" content="Math Corner blog articles by Math Corner, <?php echo $category; ?> Category <?php echo web('web_title'); ?>">
    <meta name="keywords" content="math, Corner, blog, articles, by Math Corner, sojebsikder, math corner, <?php echo $category; ?> Category <?php echo web('web_title'); ?>">
...
<?php require_once("templates/navbar.php"); ?>
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('../assets/images/');" data-stellar-background-ratio="0.5">
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-12 ftco-animate">
          	<h1 class="mb-4 mb-md-0"><strong><?php echo $category; ?></strong> Category Blog</h1>
          	<div class="row">
          		<div class="col-md-7">
          			<div class="text">
      ...
      <div class="container">
        ...
        <?php if(getPostByCategory($category)): ?>
					<?php foreach (getPostByCategory($category) as $row): ?>
            <?php
						$linkbyId ="blog-single.php?id={$row['id']}";
						$linkbyName ="blog-single.php?name={$row['blog_name']}";
						?>
